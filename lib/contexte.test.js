...
test('cheminHorsFacade bloque parametres hors commune et tarifs hors PME', function () {
  ...
  assert.equal(cheminHorsFacade('/dashboard/tarifs', region), true);
  assert.equal(cheminHorsFacade('/dashboard/paiements', region), true);
  assert.equal(cheminHorsFacade('/dashboard/paiements', admin), false);
